...
copy the groundtruth data to "train Hillcube" and "train RPM" folders and execute specified scripts(specified in readme text in each folder) to get the Hillcube models and RPM models respectively, that closely approximates the groundtruth data. 
