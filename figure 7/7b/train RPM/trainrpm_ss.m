...
LL=[size(gatecells{1},1) size(gatecells{2},1) size(gatecells{3},1) size(gatecells{4},1)]; %counts L for each node refer to equation (2) in the manuscript. L is the number of conjunction terms
