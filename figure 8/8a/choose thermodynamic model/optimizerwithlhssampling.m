...
network=[1 -1 1 0;-1 1 0 1]; %Network representation nodes in the order [A B I1 I2]
PAR=[];
car=[];
...
%initial conditions for internal nodes A and B with stating values of zero
