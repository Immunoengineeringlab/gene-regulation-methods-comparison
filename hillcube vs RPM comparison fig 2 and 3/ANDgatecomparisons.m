...
G{1}=[1 1]; % AND gate of two inputs. (unit entries in the same row represents AND combination and multiple rows represent OR gate. for example: G=[1 0;0 1] represents OR gare
