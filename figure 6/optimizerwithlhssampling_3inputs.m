...
network=[-1 1 1]; % matrix codes for the type of connections to the node. here it denotes 5 inputs with two inhibiting inputs denoted by -1. single row since we have only one node in the network.
PAR=[];
car=[];
